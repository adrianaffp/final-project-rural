...
const Hero = () => {
	return (
		<>
			<div
				className='h-[calc(100vh-12rem)] w-full bg-cover bg-top rounded-xl'
				style={{
			...
			>
				...
				<div className='grid grid-cols-1 lg:grid-cols-2 place-items-center h-full'>
					<div className='space-y-5 ml-10 md:space-y-10'>
						...
						<h4 className='max-w-[400px] text-slate-100 text-sm'>With rural Portugal every journey is an opportunity for adventure, discovery and unforgettable moments!</h4>
					</div>
				</div>
			</div>
		</>
